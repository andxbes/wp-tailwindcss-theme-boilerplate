<div class="fixed inset-0 flex items-center justify-center bg-blue-700 Example">
	<div class="max-w-2xl px-4 py-16 mx-auto text-center Example__inner sm:py-20 sm:px-6 lg:px-8">
		<h2 class="text-3xl font-extrabold text-white Example__title sm:text-4xl">
		...
		<p class="mt-4 text-lg leading-6 text-blue-200">
			...
			<a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer">Tailwind CSS v3</a> &
		...
		<a href="https://philkurth.com.au/" target="_blank" rel="noopener noreferrer"
		...
		<a href="https://twitter.com/mishterkurth" target="_blank" rel="noopener noreferrer"
			class="inline-flex items-center justify-center w-full px-5 py-3 mt-8 text-base font-medium text-blue-600 bg-white border border-transparent rounded-md hover:bg-blue-50 sm:w-auto">
			<!-- SVG: Twitter bird -->
			<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
				<path
